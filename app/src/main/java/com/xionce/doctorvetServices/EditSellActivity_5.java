...
public class EditSellActivity_5 extends EditBaseActivity {

    private static final String TAG = "EditSellActivity_5";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.content_edit_sell_5);
    ...
    private void send_pdf_sell_request(Integer id_sell) {
        ...
        TokenStringRequest stringRequest = new TokenStringRequest(Request.Method.GET, pdfSellEndPoint.toString(), new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    HelperClass.writeToFile(response, EditSellActivity_5.this, "sell.pdf");
                    boolean success = HelperClass.viewPdf("sell.pdf", EditSellActivity_5.this);
                    if (!success)
                        Snackbar.make(DoctorVetApp.getRootForSnack(EditSellActivity_5.this), getString(R.string.err_pdf_viewer), Snackbar.LENGTH_SHORT).show();
                } catch (Exception ex) {
