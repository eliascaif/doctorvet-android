...
public class SearchServiceCategoryActivity extends SearchActivityBase implements HelperClass.AdapterOnClickHandler {

    private static final String TAG = "SearchServiceCategoryAc";
    ...
    public void search(boolean on_first_fill) {
        ...
        showProgressBar();
        hideFailSearch();
        DoctorVetApp.get().getServicesCategoriesPagination(getSearchText(), getPage(), new DoctorVetApp.VolleyCallbackPagination() {
            @Override
            public void onSuccess(Get_pagination pagination) {
                ...
                if (pagination != null) {
                    ...
                    productscategoriesAdapter.setOnClickHandler(SearchServiceCategoryActivity.this);
                    ...
                    DoctorVetApp.get().handle_null_adapter("Services_categories", TAG, true);
                    showErrorMessage();
                }
            }
        });
