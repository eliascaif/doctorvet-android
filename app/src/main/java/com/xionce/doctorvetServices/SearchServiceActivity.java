...
public class SearchServiceActivity extends SearchActivityBase implements HelperClass.AdapterOnClickHandler {

    private static final String TAG = "SearchServicioActivity";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        txtBuscar.setHint(getString(R.string.buscar_servicios));
        search(true);
        setRecyclerView();
    }
    ...
    public void search(boolean on_first_fill) {
        ...
        showProgressBar();
        hideFailSearch();
        DoctorVetApp.get().getVetServicesPagination(getSearchText(), getPage(), new DoctorVetApp.VolleyCallbackPagination() {
            @Override
            public void onSuccess(Get_pagination pagination) {
                ...
                if (pagination != null) {
                    ...
                    productsAdapter.setOnClickHandler(SearchServiceActivity.this);
                    ...
                    DoctorVetApp.get().handle_null_adapter("Products", /*SearchServiceActivity.this,*/ TAG, true);
                    showErrorMessage();
                }
            }
        });
        ...
        DoctorVetApp.get().getVetServicesPagination(getSearchText(), getPage(), new DoctorVetApp.VolleyCallbackPagination() {
            ...
            public void onSuccess(Get_pagination pagination) {
                ...
                if (pagination != null) {
                    ...
                    DoctorVetApp.get().handle_null_adapter("Productos", /*SearchServiceActivity.this,*/ TAG, true);
                    showErrorMessage();
                }
            }
        });
